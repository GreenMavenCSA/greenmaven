...
ALTER TABLE farmhacker_user ADD COLUMN is_driver INT DEFAULT 0 NOT NULL;
...
-- Lengthen the username field for the users table
ALTER TABLE farmhacker_user MODIFY username VARCHAR(100) NOT NULL;
