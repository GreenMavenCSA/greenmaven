...
public class InventoryRecord extends UpdatableRecordImpl<InventoryRecord> implements Record4<Integer, Integer, Short, Timestamp> {

    private static final long serialVersionUID = 1170096236;
     ...
     */
    @Override
    public Row4<Integer, Integer, Short, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row4<Integer, Integer, Short, Timestamp> valuesRow() {
     ...
     */
    @Override
    public InventoryRecord values(Integer value1, Integer value2, Short value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public InventoryRecord(Integer id, Integer catalogId, Short measure, Timestamp timeEntered) {
        super(Inventory.INVENTORY);
