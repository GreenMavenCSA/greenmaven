...
public class FarmhackerUserRecord extends UpdatableRecordImpl<FarmhackerUserRecord> implements Record9<String, String, String, Integer, Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1718829974;
    ...
    /**
     * Setter for <code>farmhacker.farmhacker_user.is_driver</code>.
     */
    ...
    /**
     * Getter for <code>farmhacker.farmhacker_user.is_driver</code>.
     */
     ...
     */
    @Override
    public Row9<String, String, String, Integer, Integer, Integer, Integer, Integer, Integer> fieldsRow() {
     ...
     */
    @Override
    public Row9<String, String, String, Integer, Integer, Integer, Integer, Integer, Integer> valuesRow() {
    ...
    public Field<Integer> field6() {
        return FarmhackerUser.FARMHACKER_USER.IS_DRIVER;
    }
     ...
     */
    @Override
    public FarmhackerUserRecord value9(Integer value) {
        setMarketId(value);
        return this;
    }
     ...
     */
    @Override
    public FarmhackerUserRecord values(String value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public FarmhackerUserRecord(String username, String password, String role, Integer isEater, Integer isGrower, Integer isDriver, Integer isFacebookUser, Integer zip, Integer marketId) {
        super(FarmhackerUser.FARMHACKER_USER);
