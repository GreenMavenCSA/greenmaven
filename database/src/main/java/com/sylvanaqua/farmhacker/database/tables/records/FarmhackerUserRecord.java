...
public class FarmhackerUserRecord extends UpdatableRecordImpl<FarmhackerUserRecord> implements Record3<String, String, String> {

    private static final long serialVersionUID = 1774926447;
     ...
     */
    @Override
    public FarmhackerUserRecord values(String value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public FarmhackerUserRecord(String username, String password, String role) {
        super(FarmhackerUser.FARMHACKER_USER);
